...
namespace RKFScheme
{
  ...
  struct DormandPrince : public ButcherArray<7>
  {
    DormandPrince()
      : ButcherArray<7>{
          {{
  ...
  struct RK45 : public ButcherArray<6>
  {
    RK45()
      : ButcherArray<6>{
          {{{{0., 0., 0., 0., 0., 0.}},
  ...
  struct RK23 : public ButcherArray<4>
  {
    RK23()
      : ButcherArray<4>{
          {{{{0., 0., 0., 0.}},
  ...
  struct FehlbergRK12 : public ButcherArray<3>
  {
    FehlbergRK12()
      : ButcherArray<3>{
          {{
  ...
  struct RK12 : public ButcherArray<2>
  {
    RK12()
      : ButcherArray<2>{{{
                          {{0., 0.}},
