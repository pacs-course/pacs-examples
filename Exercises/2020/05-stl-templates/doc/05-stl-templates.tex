...
Implement a \texttt{C++} class to compute derivatives of any order of a given function using recursive backward/forward first-order finite difference formulas.
\end{frame}
