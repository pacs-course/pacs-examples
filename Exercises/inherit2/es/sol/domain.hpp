...
namespace Geometry
{
  ...
  /*!
    @class Domain1D
    This class implement the comcept of 1D domain, i.e. an interval.
    It stores the left and right extreme of the interval.
    The values are readed using GetPot, or imposed using the set methods.
  */
  class Domain1D
  {
  ...
  public:
    ...
    /*!
      ...
      @param section Constant reference for the section to read
        the parameters in the datafile.
    */
    ...
    */
    void setLeft ( const double & left ) { M_a = left; }

    /*!
      Set the value of right extreme.
      @param right Constant reference to the right extreme.
    */
    void setRight ( const double & right ) { M_b = right; }
