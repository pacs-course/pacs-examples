...
\only<3>{file {\tt v0.2/config.h}}
\only<4-6>{file {\tt v0.2/fem1d.h}}
\tiny
...
\only<3>{\lstinputlisting[language=C++,numbers=left, numberstyle=\tiny\color{gray}]{../v0.2/config.h}}
\only<4>{\lstinputlisting[language=C++, firstline=1, firstnumber=1, lastline=35, numbers=left, numberstyle=\tiny\color{gray}]{../v0.2/fem1d.h}}
\only<5>{\lstinputlisting[language=C++, firstline=30, firstnumber=30, lastline=65, numbers=left, numberstyle=\tiny\color{gray}]{../v0.2/fem1d.h}}
\only<6>{\lstinputlisting[language=C++, firstline=60, firstnumber=60, lastline=95, numbers=left, numberstyle=\tiny\color{gray}]{../v0.2/fem1d.h}}
