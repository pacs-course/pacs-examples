...
int main() {
  ...
  Robust<double, f<double> > r_double (numeric_limits<double>::epsilon () * 4, 100, 
  ...
  Robust<float, f<float> > r_float (numeric_limits<float>::epsilon () * 4, 100, 
  ...
  /// Solve the problem using 64 bit doubles
  Robust<long double, f<long double> > r_ldouble (numeric_limits<long double>::epsilon () * 4, 100, 
