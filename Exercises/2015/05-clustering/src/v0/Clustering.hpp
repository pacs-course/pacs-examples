...
//setup
template <size_t N, class DistanceP>
void Clustering<N, DistanceP>::setup( real tol, int maxIt, bool verbose )
{
    M_tol = tol;
    M_maxIt = maxIt;
    M_verbose = verbose;
...
template <size_t N, class DistanceP>
void Clustering<N, DistanceP>::apply( objectList_T const & objects )
{
...
template <size_t N, class DistanceP>
bool Clustering<N, DistanceP>::updateCentroids()
{
