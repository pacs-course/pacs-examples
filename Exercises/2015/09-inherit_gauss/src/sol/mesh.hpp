...
namespace Generator
{
  ...
  std::vector<double> uniform ( double const & a,
                                double const & b,
  ...
  */
  ...
  public:
    ...
    /*!
      ...
      @param section Constat reference for the section to read the
    ...
    */
    double operator []( const int& i ) const { return M_nodes[i]; }
    ...
    /*!
      ...
      @return The node selected.
    */
    double& operator []( const int& i ) { return M_nodes[i]; }

    /*!
      Return the constant domain meshed.
      @return The domain meshed.
    */
    const Domain1D& domain() const { return M_domain; }
