...
But you are welcome to contribute by activating a pull request. You proposed changes will be examined and, if considered appropriate, merged in the repository code.
By contributing you accept the licence agreement contined in the root folder of the git repository.

I wish also to thank the students that reported bugs and contributed to better this examples.
