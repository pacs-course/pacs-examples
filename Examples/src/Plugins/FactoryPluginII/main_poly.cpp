 ...
 *
 * The program loads the shared libraries listed in `plugins.txt`. Static
 * registration objects inside those libraries populate `polyFactory` as a side
 * effect of loading. The user can then request a polygon by name, and the
 * corresponding object is created through the registered builder.
 */
int
main()
{
