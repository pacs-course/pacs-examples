...
#pragma omp parallel for reduction (+:res)
    ...
    /*!
     * Eigen matrices (and thus also Eigen vectors) have a method sqaredNorm that returns
     * the square of the norm. I need to have an adapter that provides an interface
     * usable also with standard vectors.
     *
     ...
     *
     * Eigen matrices (and thus also vectors) have a method sqaredNorm that returns
     * the square of the norm. Here I need the corresponding function.
