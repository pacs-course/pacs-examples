...
loadFunctions()
{
  ...
  // incomplete elliptic integral of the first kind, from the STL cmath lib
  // (since c++17); note I need to specify template argument explicitely to get
  // the correct overload
  Ffactory.add(2, &std::ellint_1<double, double>);
  // atan2 form std: note I need to specify template argument explicitely to get
  // the correct overload
