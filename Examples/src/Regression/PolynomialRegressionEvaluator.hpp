...
namespace LinearAlgebra
{
  ...
  public:
     ...
     * @note the size of parameters must match the number of basis functions in ModelBasis
     */
    double eval(double const & x, Parameters const & parameters) const
    {
      // dot is a method of Eigen vectors so model.eval() and parameters should be Eigen vectors
    ...
    /*!
     * @note Only required if we use a gradient scheme to compute the optimal parameters
     */
