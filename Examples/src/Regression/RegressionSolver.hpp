...
namespace LinearAlgebra
{
  ...
  public:
     ...
     *
     * @note compared to the version above, this method does not allow to move into the
     * changed model. A copy operation is performed (unless the compiler is very smart).
     *
     * \code
