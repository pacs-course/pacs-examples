...
public:
  //! Constructor taking the point Id
  Triangle(unsigned int a, unsigned int b, unsigned int c): M_pointId{{a,b,c}} {}
  ...
  {
    return { Edge{M_pointId[0], M_pointId[1]}, Edge{M_pointId[1], M_pointId[2]}, Edge{M_pointId[2], M_pointId[0]}};
  }
