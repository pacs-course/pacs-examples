...
main()
{
  ...
  apsc::make_simplex(t, apsc::PointInS_Traits::Point2D{0.0, 0.0},
                     apsc::PointInS_Traits::Point2D{1.0, 0.0},
                     apsc::PointInS_Traits::Point2D{0.0, 1.0});
  ...
  std::cout << "The baricentric coordinates are " << lambda[0] << ", "
            << lambda[1] << ", " << lambda[2] << '\n';
  // Creating a tetrahedron
  apsc::PointInS_Traits::Tetrahedron tet;
  apsc::make_simplex(tet, apsc::PointInS_Traits::Point3D{0.0, 0.0, 0.0},
                     apsc::PointInS_Traits::Point3D{1.0, 0.0, 0.0},
                     apsc::PointInS_Traits::Point3D{0.0, 1.0, 0.0},
                     apsc::PointInS_Traits::Point3D{0.0, 0.0, 1.0});
  ...
  std::cout << "The point is " << (in3 ? "" : "not ")
            << "inside the tetrahedron\n";
  std::cout << "The baricentric coordinates are " << lambda3[0] << ", "
            << lambda3[1] << ", " << lambda3[2] << ", " << lambda3[3] << '\n';
  // Now a triangle in 3D!
  apsc::PointInS_Traits::Triangle3D t3;
  apsc::make_simplex(t3, apsc::PointInS_Traits::Point3D{0.0, 0.0, 0.0},
                     apsc::PointInS_Traits::Point3D{1.0, 0.0, 0.0},
                     apsc::PointInS_Traits::Point3D{0.0, 1.0, 0.0});
  // Checking if the point is inside the triangle
  std::cout << "Insert the coordinates of the 3D point\n";
  ...
  std::cout << "The point is " << (in3D ? "" : "not ")
            << "inside the triangle\n";
  std::cout << "The point is " << (Inplane ? "" : "not ")
            << "in the triangle plane\n";
  std::cout << "The distance from the triangle plane is " << distance
            << std::endl;
  std::cout << "The baricentric coordinates are " << lambda3D[0] << ", "
            << lambda3D[1] << ", " << lambda3D[2] << '\n';
