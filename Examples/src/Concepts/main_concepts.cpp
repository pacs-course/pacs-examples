...
main()
{
  ...
  */
  ...
  std::cout << "is Foo clonable? " << std::boolalpha
            << apsc::concepts::clonable<Foo> << std::endl;
  std::cout << "is Foo2 clonable? " << std::boolalpha
            << apsc::concepts::clonable<Foo2> << std::endl;
}
