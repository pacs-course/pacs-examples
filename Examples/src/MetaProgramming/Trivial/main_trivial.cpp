...
main()
{
  ...
  std::cout << " Aggregate:           " << std::is_trivial<Aggregate>::value
            << std::endl;
  ...
  std::cout << " Aggregate:           "
            << std::is_trivially_copyable<Aggregate>::value << std::endl;
  std::cout << " TriviallyCopyable:   "
            << std::is_trivially_copyable<TriviallyCopyable>::value
            << std::endl;
  std::cout << " StandardLayout:      "
            << std::is_trivially_copyable<StandardLayout>::value << std::endl
            << std::endl;

  std::cout << " Has it standard layout?" << std::endl;
  std::cout << " Agregate:            "
            << std::is_standard_layout<Aggregate>::value << std::endl;
  std::cout << " TriviallyCopyable:   "
            << std::is_standard_layout<TriviallyCopyable>::value << std::endl;
  std::cout << " StandardLayout:      "
            << std::is_standard_layout<StandardLayout>::value << std::endl
            << std::endl;

  std::cout << " Is it an aggregate?" << std::endl;
  std::cout << " Aggregate:           " << std::is_aggregate<Aggregate>::value
            << std::endl;
  std::cout << " TriviallyCopyable:   "
            << std::is_aggregate<TriviallyCopyable>::value << std::endl;
  std::cout << " StandardLayout:      "
            << std::is_aggregate<StandardLayout>::value << std::endl
            << std::endl;
  ...
  std::cout << "After calling the C function the values should be 3 and 7.:"
            << std::endl;
  std::cout << sl.a() << " " << sl.b() << std::endl;
