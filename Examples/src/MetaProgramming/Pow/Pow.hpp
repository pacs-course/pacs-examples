...
template <unsigned int N> using IntToType = std::integral_constant<unsigned int, N>;

//! Overload for N=0
template <class R>
constexpr R
pow (const R &x, IntToType<0u>)
{
...
//! Bust since c++17 we can getting rid of tag dispatching and doing things more
//! simply
...
template <class R>
constexpr R
POW (const R & x, const unsigned int N)
{
