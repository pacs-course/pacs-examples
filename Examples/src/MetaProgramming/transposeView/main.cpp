...
// I use the fact that Eigen matricies are done properly: they give information about the
// relevant types!
...
int main()
{
  ...
  // mtc(0,1)=10.f; //Error even if mtc is not constant the stored matrix is constant!!
  
  // Now a different way to build a trasposedView, without the helper function, thanks to the deduction guide
  // The template argument is automatically deduced thanks to the deduction guide!
