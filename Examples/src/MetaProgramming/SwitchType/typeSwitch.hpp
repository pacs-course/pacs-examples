...
namespace apsc::Geometry2
{
  ...
  template<>
  struct IntToElement<0> : std::integral_constant<int,0>
  {
  ...
  template<>
  struct IntToElement<1>: std::integral_constant<int,1>
  {
  ...
  template<>
  struct IntToElement<2>: std::integral_constant<int,2>
  {
  ...
  template<>
  struct IntToElement<3>: std::integral_constant<int,3>
  {
