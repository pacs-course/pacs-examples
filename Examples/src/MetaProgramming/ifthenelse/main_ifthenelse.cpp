...
// Returns a long double if T is floating type, and a long int if T is an integral type
template<typename T>
apsc::TypeTraits::IfThenElse_t<std::is_floating_point<T>::value,long double, long int>
