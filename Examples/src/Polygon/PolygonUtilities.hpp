...
{
/*!
 * @fn std::unique_ptr<AbstractPolygon> createPolygon(const std::string&, Args...)
 ...
 * @return A pointer to the abstract class pointing to the newly created concrete Polygon
 */
