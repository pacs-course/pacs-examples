...
/*!
  ...
  @detail With explicit instantiation we tell the compiler to generate the code for the template
  with the specified template arguments. For a class template all methods will be compiled.
 */
