...
main()
{
  ...
  std::vector<int>   vi{1, 2, 3,
                      4, 5, 6}; // vector has (at least) 2 template parameters
  std::set<double>   sd{2., 3.4, -9.0,
                      3.7}; // set has (at least) 3 template parameters
  ...
  // It does not work with std::arrays: the 2nd template parameter is a value
  // not a type. But it works also with unordered_set and list.
