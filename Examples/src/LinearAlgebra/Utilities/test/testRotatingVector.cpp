...
main()
{
  ...
  std::cout << "I create a rotatingvector of size 3 of arrays of size 3"
            << std::endl;
  ...
  std::cout << "I create a rotatingvector of maximal size 4 of arrays of size 3"
            << std::endl;
  ...
  printRV(rvx);
  std::cout << "The last element   " << rvx.back()[0] << "," << rvx.back()[1]
            << "," << rvx.back()[2] << std::endl;
  std::cout << "The last-1 element " << rvx.back<1>()[0] << ","
            << rvx.back<1>()[1] << "," << rvx.back<1>()[2] << std::endl;
