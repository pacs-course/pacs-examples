...
{
  /*!
   * Computing the gradient via finite differences. This enum class determines the type of differencing.
   */
   ...
   *
   * @tparam FDT The finite difference type to be used for computing the approximate gradient
   */
  ...
  public:
    ...
    void setFunction(const LineSearch_traits::CostFunction & ff){f=ff;}
