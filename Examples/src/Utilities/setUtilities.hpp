  ...
  -> OrderedContainer
{
  ...
  std::set_difference(a.begin(), a.end(), b.begin(), b.end(),
                      std::inserter(c, c.begin()), Compare{});
  return c;
}
/*!
...
template <class OrderedContainer>
auto
set_union(OrderedContainer const &a, OrderedContainer const &b)
  -> OrderedContainer
{
  OrderedContainer c;
  using Compare = typename OrderedContainer::key_compare;
...
template <class OrderedContainer>
auto
set_intersection(OrderedContainer const &a, OrderedContainer const &b)
  -> OrderedContainer
{
  OrderedContainer c;
  using Compare = typename OrderedContainer::key_compare;
