...
namespace multicity
{
  ...
  auto
  computeR0(
    EModelData const &data,
    typename MultiCityModelTraits<
      EModelData::NCities, EModelData::NVar>::PopulationVariableType const &N,
    double t) -> typename EModelData::VectorType
  {
