...
namespace RKFScheme
{
  ...
  struct DormandPrince_t : public ButcherArray<7>
  {
    DormandPrince_t()
      : ButcherArray<7>{
          {{
  ...
  struct FehlbergRK12_t : public ButcherArray<3>
  {
    FehlbergRK12_t()
      : ButcherArray<3>{
          {{
  ...
  // C++17 here!
  inline const DormandPrince_t DP{};

  inline const RK45_t RK45{};

  inline const RK23_t RK23{};

  inline const FehlbergRK12_t FRK12{};
